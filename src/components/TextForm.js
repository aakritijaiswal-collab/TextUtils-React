...
<button disabled={text.length===0}  className="btn btn-primary mx-1 my-2" onClick={handleDownClick}>Convert to lowercase</button>
<button disabled={text.length===0}  className="btn btn-primary mx-1 my-2" onClick={handleClClick}>Clear Text</button>
...
<button disabled={text.length===0}  className="btn btn-primary mx-1 my-2" onClick={handleExClick}>Extract the email</button>
</div>
